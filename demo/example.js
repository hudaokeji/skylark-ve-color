function initPage($) {
    ...
    function toggleButtonState() {
        var options = colorpickerInput.colorPicker("option");
    ...
    $(document).on("click", ".toggleBtn", function() {
        ...
        var existing = colorpickerInput.colorPicker("option", option);

        colorpickerInput.colorPicker("option", option, !existing);
        toggleButtonState();
    });
    ...
    $("#size").change(function() {
        ...
        colorpickerInput.colorPicker("reflow");
    });
    ...
    $(function() {
      for (var i in palettes) {
        ...
        $("<input />").appendTo("#palettes").colorPicker({
          flat: true,
          showInput: true,
          className: i,
          preferredFormat: "rgb",
